              ...
              <div className="flex h-16 justify-between">
                <div className="flex">
                  ...
                  <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                    ...
                    <Link to="/admin/user_inventory_check" className="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-white">
                      Inventory Review
                    </Link>
                  </div>
                </div>
